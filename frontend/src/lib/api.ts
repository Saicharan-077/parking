...
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'http://127.0.0.1:6228/api/v1';
...
export interface Vehicle {
  ...
  phone_number?: string; // Phone number (optional - auto-filled from user profile)
